...
//        public ApiRoomController(ApplicationDbContext context, IMapper mapper, IHubContext<ChatHub> hubContext)
//        {
//            _context = context;
//            _mapper = mapper;
...
//            var user = _context.ApplicationUser.FirstOrDefault(u => u.UserName == User.Identity.Name);
//            var room = new Room()
//            {
//                Name = roomViewModel.Name,
//                Admin = (CodeFirst.Models.ApplicationUser)user,
//            };
